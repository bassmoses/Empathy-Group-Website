...
<script>
    ...
    <div>
        <header>
            <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white transparency border-bottom border-light" id="transmenu">
                <div class="container"><a class="navbar-brand text-success" href="index.php"><i class="fa fa-leaf fa-2x"><img src="images/me.png" alt="Logo" width="100" height="50"></i>&nbsp;EMPATHY GROUP LTD</a><button data-bs-toggle="collapse" class="navbar-toggler collapsed" data-bs-target="#navcol-1"><span></span><span></span><span></span></button>
            ...
            <div class="bg-success d-flex align-items-center" style="height: 100vh;">
                ...
                <div class="text-center w-100 text-white">
                    <h1>Empathy Group limited</h1>
                    <h2 class="fw-normal"><em>Bringing multiple businesses under one umbrella</em></h2>
                </div>
            </div>
        </header>
    </div>
    ...
    <script src="assets/js/Youtube-Video-Lazyload-YouTube-Video-Lazyloader.js"></script>
</body>
