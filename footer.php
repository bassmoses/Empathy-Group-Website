...
<footer class="text-white bg-dark">
            <div class="container py-4 py-lg-5">
                <div class="row justify-content-center">
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <ul class="list-unstyled">
                            <li><a class="link-light" href="#">Telecommunication</a></li>
                            <li><a class="link-light" href="#">Energy</a></li>
                            <li><a class="link-light" href="#">Construction</a></li>
                            <li><a class="link-light" href="#">Information and Communication Technology (ICT)</a></li>
                            <li><a class="link-light" href="#">Real Estate Development</a></li>
              ...
              <img src="images/me.png" alt="Logo" width="100" height="50">
            </a>

                                <span>Empathy Group LTD.</span></div>
                        <p class="text-muted copyright">Bringing multiple businesses under one umbrella.</p>
                    </div>
                </div>
                <hr>
                <div class="d-flex justify-content-between align-items-center pt-3">
                    <p class="mb-0">Copyright © 2023 Empathy Group LTD.</p>
